            ...
            {categories_vallue &&
                categories_vallue.slice(0, 3).map((value) => (
                    <Link
                        ...
                        className="group flex justify-between items-center bg-white/10 hover:bg-white/20 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg transition-all duration-200"
                    >
                        <span className="text-gray-200 group-hover:text-white text-xs sm:text-sm truncate">
                            {value.title}
                        </span>
